<template>
  <div class="view-container">
    ...
    <div class="filter-container">
      ...
      <el-row type="flex" justify="space-between">
        ...
        <el-col :span="10">
          ...
          <el-col :span="18">
            <el-input v-model="queryList.planName" placeholder="请输入计划名称" style="width: 210px;" class="filter-item" @keyup.enter.native="handleFilter" />
            <el-button class="my-icon-button" icon="el-icon-search" @click="handleFilter" />
          </el-col>
        </el-col>
        <!-- 下拉框 计划状态 -->
        <el-col :span="10">
        <el-col :span="6">
          ...
          <el-col :span="18">
            <el-select v-model="queryList.planStatus" placeholder="请选择计划状态" clearable style="width: 250px" class="filter-item">
        ...
        <el-col :span="5">
          <!-- 按钮 重置 -->
          <el-button class="filter-item" icon="el-icon-edit" @click="handleReset">
            重置
          </el-button>
          <!-- 按钮 查询 -->
    ...
    <div class="function-button-container">
      <el-row type="flex" justify="end">
        <el-col :span="6">
          ...
          <!-- 按钮 批量删除 -->
          <el-button class="filter-item" icon="el-icon-delete" @click="handleBatchDelete">
            批量删除
          </el-button>
        </el-col>
      </el-row>
    ...
    >
      ...
      <el-table-column label="缩略图" prop="groupID" align="center" width="100px" :class-name="getSortClass('groupID')">
      ...
      <el-table-column label="操作" width="200px" align="center">
        <template slot-scope="{row,$index}">
          <el-button type="text" @click="handleMoreInfo(row)">
            详情
          </el-button>
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="90px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="所属机构:" prop="agency">
          <el-select v-model="temp.agency" class="filter-item" placeholder="请选择所属机构">
            <el-option v-for="item in agencyList" :key="item" :label="item" :value="item" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="设备选择:">
          <el-select v-model="temp.status" class="filter-item" placeholder="请选择设备">
            <el-option v-for="item in equNameList" :key="item" :label="item" :value="item" />
          </el-select>
        </el-form-item>
      </el-form>
    ...
    <!-- 对话框 详情 -->
    <el-dialog :title="dialogTitleMap[dialogStatus]" :visible.sync="dialogTableVisible">
      <template>
...
export default {
  ...
  data() {
    return {
      ...
      planStatusList: ['所有状态', '待发布', '发布中', '发布成功', '部分成功', '发布失败', '已结束', '已失效', '审核中', ],
